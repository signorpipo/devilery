...
export function initObjectExtensionProtoype() {
        ...
        return function pp_clone(cloneParams = new CloneParams()) {
            ...
            if (this.pp_isCloneable(cloneParams)) {
                ...
                while (objectsToCloneData.length > 0) {
                    ...
                    let currentClonedObject = (parent != null) ? parent.pp_addObject() : Globals.getScene(this.pp_getEngine()).pp_addObject();
    ...
    objectExtension.pp_addObject = function pp_addObject() {
        return Globals.getScene(this.pp_getEngine()).addObject(this);
    };
    ...
    objectExtension.pp_reserveObjectsSelf = function pp_reserveObjectsSelf(count) {
        ...
        _reserveObjects(count, componentsAmountMap, Globals.getScene(this.pp_getEngine()));
    };
